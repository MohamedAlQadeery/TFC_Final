...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">@lang('dashboard.create_food')</li>
    </ol>
  </nav>
    <!-- Form row -->
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">@lang('dashboard.create_food')</h4>
                <p class="text-muted mb-3 font-13">
                    @lang('dashboard.create_food_desc')
                </p>
                @include('dashboard.partials._errors')

                <form action="{{ route('dashboard.foods.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="inputEmail4" class="col-form-label">@lang('dashboard.ar_name')</label>
                            <input type="text" name="ar_name" value="{{ old('ar_name') }}" class="form-control"  placeholder="@lang('dashboard.ar_name_placeholder')">
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="form-row">
                        ...
                        <textarea name="ar_desc"  placeholder="@lang('dashboard.food_desc')"  class="form-control">{{ old('ar_name') }}</textarea>
                        </div>

                        <div class="form-group col-md-4">
                            <label  class="col-form-label">@lang('dashboard.en_desc') (@lang('dashboard.optional'))</label>
                        <textarea name="en_desc"  placeholder="@lang('dashboard.food_desc')"  class="form-control">{{ old('en_name') }}</textarea>
                        </div>


                        <div class="form-group col-md-4">
                            <label  class="col-form-label">@lang('dashboard.tr_desc') (@lang('dashboard.optional'))</label>
                        <textarea name="tr_desc"  placeholder="@lang('dashboard.food_desc')"  class="form-control">{{ old('tr_desc') }}</textarea>
                        </div>
                    ...
                    <div class="form row">
                       <div class="form-group col-md-6">
                        <label  class="col-form-label">@lang('dashboard.attributes')(@lang('dashboard.optional'))</label>
                        <select id="choose_attributes" name="attributes[]"  class="form-control"  multiple>
                            ...
                            <option value="{{ $attr->id }}">{{ app()->getLocale()=='ar' ? $attr->ar_name:$attr->en_name }}</option>
                            @endforeach
                            </select>
                       </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="fats" value="{{ old('fats') }}" class="form-control"  placeholder="@lang('dashboard.ar_name_placeholder')">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputEmail4" class="col-form-label">@lang('dashboard.carbs') (@lang('dashboard.optional'))</label>
                            <input type="text" name="carbs" value="{{ old('carbs') }}" class="form-control"  placeholder="@lang('dashboard.ar_name_placeholder')">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputEmail4" class="col-form-label">@lang('dashboard.protein') (@lang('dashboard.optional'))</label>
                            <input type="text" name="protein" value="{{ old('protein') }}" class="form-control"  placeholder="@lang('dashboard.ar_name_placeholder')">
                        </div>
                    </div>
...
//show submit button after upload completed
pond.onprocessfiles = () => {
